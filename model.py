"""
    Modified from "modeling_pegasus.py" file from transformers @ HuggingFace
"""
...
from transformers import BeamSearchScorer, LogitsProcessorList, BeamScorer, PretrainedConfig, BartTokenizer
...
class TAASForConditionalGeneration(PegasusPreTrainedModel):
    ...
    def adjust_logits_during_generation(self, logits, cur_len, max_length):
        ...
        if cur_len == 1:
            self._force_token_id_to_be_generated(logits, self.config.decoder_start_token_id)
