...
class ModelArguments:
    ...
    freeze_encoder_layer: Optional[int] = field(default=None,
                                            metadata={"help": "Whether to freeze some layers of the encoder"})
    freeze_decoder_layer: Optional[int] = field(default=None,
                                            metadata={"help": "Whether to freeze some layers of the decoder"})
    reset_encoder: bool = field(default=False, metadata={"help": "Whether tp reset the encoder."})
    reset_decoder: bool = field(default=False, metadata={"help": "Whether tp reset the decoder."})
    reset_encoder_layer: Optional[int] = field(default=None,
                                           metadata={"help": "Whether to reset some layers of the encoder"})
    reset_decoder_layer: Optional[int] = field(default=None,
                                           metadata={"help": "Whether to reset some layers of the decoder"})
