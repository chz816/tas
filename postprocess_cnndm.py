"""
Post-processing for CNN/DM - Modified From ProphetNet: https://github.com/microsoft/ProphetNet
"""
...
parser.add_argument("--src_file", type=str, default="./output/cnndm/test_generations.txt")
parser.add_argument("--tgt_file", type=str, default="./data/cnndm/test.target")
...
fin = open(args.src_file, 'r', encoding='utf-8')
fgolden = open(args.tgt_file, 'r', encoding='utf-8')
...
scores = rouge(generated_list, golden_list)
